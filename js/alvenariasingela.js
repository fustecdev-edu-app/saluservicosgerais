...
function adicionarAlvenariaDobrada() {
  ...
  // Valida a área
  if (!area || area <= 0) {
    alert("Informe a área da alvenaria singela.");
    return;
  }
  ...
  const blocos = area * 25;        // Número de blocos (25 blocos/m²)
  const cimento = area * 0.2;      // Sacos de cimento (0,2 saco/m²)
  const cal = area * 0.44;         // Sacos de cal (0,44 saco/m²)
  ...
  ================================= */
  orcamentoFinal.push({
    tipo: "Alvenaria Singela",   // Tipo do serviço
    ...
    maoObra: valor.toFixed(2)// Mão de obra total
  });
  ...
  resultadoDiv.innerHTML += `
    <p>
      ✔️ Alvenaria Singela adicionada<br>
