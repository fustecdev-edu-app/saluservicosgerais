...
/* ===============================
   FUNÇÃO PARA ADICIONAR CINTA
================================ */
function adicionarCinta() {
  ...
  if (!comprimento || comprimento <= 0) {
    alert("Informe o comprimento da cinta.");
    return;
  }
  ...
  // Volume de concreto
  const concreto = comprimento * largura * altura;

  // Área (padronização para relatório)
  ...
  const maoObraTotal = comprimento * valorMaoObra;
  ...
  orcamentoFinal.push({
    tipo: "Cinta",
    area: area.toFixed(2),
    dimensao: `${largura * 100} x ${altura * 100} cm`,
  ...
  resultadoDiv.innerHTML += `
    <p>
      ✔️ Cinta adicionada<br>
      Comprimento: ${comprimento.toFixed(2)} m<br>
      Dimensão: ${largura * 100} x ${altura * 100} cm<br>
