...
/* ===============================
   FUNÇÃO PARA ADICIONAR CONTRA-PISO
================================ */
function adicionarContraPiso() {
  ...
  // Altura padrão do contra-piso (6 cm)
  const altura = 0.06; // metros
